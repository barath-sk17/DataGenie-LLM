...
menu = st.sidebar.selectbox("Choose an Option", ["DataGenie-Hackathon-CSVBot","Anti Hallinucation & Response Evaluation","Question generator","Question based Graph","Upload CSV for Graph Summarize","Upload CSV & Visualizse"])
# Streamlit setup
